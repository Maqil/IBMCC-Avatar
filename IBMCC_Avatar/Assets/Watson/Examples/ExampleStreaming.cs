...
namespace IBM.Watsson.Examples
{
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        [SerializeField]
        private string _serviceUrl = "https://gateway-lon.watsonplatform.net/speech-to-text/api";
        [Tooltip("Text field to display the results of streaming.")]
        public Text ResultsField;
        [Header("IAM Authentication")]
        [Tooltip("The IAM apikey.")]
        [SerializeField]
        private string _iamApikey = "liOt3C4cqS86vauIsjDd11uAny_ezrjp2tarts5LYrmi";
        ...
        public void StartRecording()
        {
            ...
            if (_recordingRoutine == 0 && LoginWrapper.wrapper.sttStarted)
            {
                ...
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        if(text.Split(' ').Length <= 2)
                        {
                            ...
                            if(text.ToLower().Contains("one"))
                                    text = "1";
                            else if(text.Trim().Contains("two"))
                                    text = "2";
                            else if(text.Trim().Contains("three"))        
                                    text = "3";
                            else if(text.Trim().Contains("zero"))
                                    text = "0";
                            else if(text.Trim().Contains("four"))
                                    text = "4";
                        }
                        //ResultsField.text = text;
                        LoginWrapper.wrapper.lineSTT = text;
                    }
